...
export default function ProviderScreen({ route, navigation }) {
  ...
  const showServiceDescription = async (service) => {
    try {
      ...
      setSelectedService(service);
      setIsDescriptionModalVisible(true);
      Alert.alert("Sigma Warning", "Using cached data. Weak network detected.");
    }
  };
              ...
              <>
                ...
                <View style={styles.serviceDetails}>
                  {selectedService.price && (
                    <Text style={styles.detailText}>Price: ${selectedService.price}</Text>
                  )}
                </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.notesLabel}>Enter Your Car Model</Text>
            <TextInput
              style={styles.notesInput}
              placeholder="Example: Toyota Camry 2020"
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.successModalContainer}>
            ...
            <Text style={styles.successText}>Order Sent Successfully</Text>
          </View>
        </View>
      </Modal>
    </ScrollView>
